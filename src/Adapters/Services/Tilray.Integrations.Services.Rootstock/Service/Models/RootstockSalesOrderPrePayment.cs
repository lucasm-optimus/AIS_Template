...
public class RootstockSalesOrderPrePayment
{
    ...
    private RootstockSalesOrderPrePayment() { }
    public static Result<RootstockSalesOrderPrePayment> Create(SalesOrderPrepayment soPrepayment, string divisionId, string paymentAccountId)
    {
        try
        {
            var prePayment = new RootstockSalesOrderPrePayment
            {
        ...
        {
            return Result.Fail<RootstockSalesOrderPrePayment>(e.Message);
        }
    }
