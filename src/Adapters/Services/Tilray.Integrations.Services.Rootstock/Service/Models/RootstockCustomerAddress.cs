...
public class RootstockCustomerAddress
{
    #region Properties
    ...
    #region Constructors
    private RootstockCustomerAddress() { }
    public static Result<RootstockCustomerAddress> Create(SalesOrderCustomerAddress salesOrderCustomerAddress, string customerId, int customerNextAddressSequence)
    {
        try
        {
            var rootstockCustomerAddress = new RootstockCustomerAddress
            {
        ...
        {
            return Result.Fail<RootstockCustomerAddress>(e.Message);
        }
    }
