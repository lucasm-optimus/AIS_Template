...
public class RootstockPurchaseOrderFetched_CreatePurchaseOrderInSAPConcur(IMediator mediator, ILogger<RootstockPurchaseOrderFetched_CreatePurchaseOrderInSAPConcur> logger)
{
    ...
    public async Task Run([ServiceBusTrigger(Topics.RootstockPurchaseOrderFetched, Subscriptions.CreatePurchaseOrderInSAPConcur, Connection = "ServiceBusConnectionString")] ServiceBusReceivedMessage message, ServiceBusMessageActions messageActions)
    {
        try
        {
